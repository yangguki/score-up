...
| 주제 | 원문 |
| --- | --- |
| 정의·페르소나·모듈·로드맵 | `docs/SCORE-UP-기획서.md` v0.3 |
| 버튼·상태·종료·제재 | `docs/SCORE-UP-종목-룰-명세서.md` v0.2 |
| IA·화면·카피·MVP 체크 | `docs/SCORE-UP-화면기획.md` v0.4.9 |
...
| 모임·회차·참석 투표 | `docs/SCORE-UP-모임-기획.md` v0.8.1 |
| 모임 화면 와이어 | `docs/SCORE-UP-모임-상세.md` v0.5 |
